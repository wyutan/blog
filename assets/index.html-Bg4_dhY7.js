import{_ as n,e,j as a,o as i}from"./app-C2qXDXZv.js";const l={};function t(p,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h2 id="ce系列" tabindex="-1"><a class="header-anchor" href="#ce系列"><span>CE系列</span></a></h2><h3 id="初始化" tabindex="-1"><a class="header-anchor" href="#初始化"><span>初始化</span></a></h3><div class="language- line-numbers-mode" data-ext="" data-title=""><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span>system-view</span></span>
